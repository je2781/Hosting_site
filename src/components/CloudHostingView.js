...
const CloudHostingView = (props) => {
    return(
        <div>
            <div id="header-holder">
                <Navbar leadItemName="Home" direction="/" navbarCenteredPos="absolute" navbarCenteredPosT="0"
                navbarCenteredPosL="23px"/>
                <HSHero hsName="Cloud Hosting" icon={props.icon} headerIntro="Choose from a variety of affordable, high quality shared hosting services" 
                headerIconColor="rgb(82, 145, 228)"/>
            </div>
            <HSPricing starterPrice="7.99" businessPrice="16.19" vipPrice='44.19'/>
...
export default CloudHostingView