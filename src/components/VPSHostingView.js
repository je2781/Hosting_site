...
const VPSHostingView = (props) => {
    return(
        <div>
            <div id="header-holder">
                <Navbar leadItemName="Home" direction="/" navbarCenteredPos="absolute" navbarCenteredPosT="0"
                navbarCenteredPosL="23px"/>
                <HSHero hsName="VPS Hosting" icon={props.icon} headerIntro="Choose from a variety of affordable, high quality shared hosting services"
                headerIconColor="rgb(82, 145, 228)"/>
            </div>
            <HSPricing starterPrice="22.40" businessPrice="30.60" vipPrice='58.60'/>
