...
const WordPressHostingView = (props) => {
    return(
        <div>
            <div id="header-holder">
                <Navbar leadItemName="Home" direction="/" navbarCenteredPos="absolute" navbarCenteredPosT="0"
                navbarCenteredPosL="23px"/>
                <HSHero hsName="WordPress Hosting" icon={props.icon} headerIntro="Choose from a variety of affordable, high quality shared hosting services"
                headerIconColor="rgb(82, 145, 228)"/>
            </div>
            <HSPricing starterPrice="5.34" businessPrice="13.54" vipPrice='41.54'/>
...
export default WordPressHostingView